...
Depending on your configuration, point adjustments may require:
...
{% hint style="danger" %}
**Negative Balances:**
The system may prevent adjustments that would result in negative point balances. Verify available balance before deducting points.
{% endhint %}
