...
Learn how to create a new tenant/merchant account in the Loyalty CRM system.

## Overview

Adding a new tenant allows businesses to participate in your loyalty program.

## Accessing Add Tenant

Navigate to **Tenants > Tenant Management > Add New Tenant**
...
Click **Save** to create the tenant account.

## Post-Creation Steps

After creating the tenant:

1. **Create User Account** - Set up login credentials for the tenant
2. **Assign Permissions** - Configure access levels
3. **Configure Rewards** - Assign applicable rewards
4. **Training** - Provide system training
5. **Testing** - Verify tenant functionality

## Creating Tenant User Login

### Step 1: Navigate to User Creation

Go to **Administration > Create User**
...
Click **Create** to generate the user account.
