...
Learn how to update your profile information in the Loyalty CRM system.

## Overview

Keep your profile information up-to-date to ensure smooth communication and system access.
...
2. Use **"Crop Image"** to adjust the selection
3. Click **"Upload"** to save the new profile picture

### Step 4: Save Changes

After making your updates, click the **Save** button to apply all changes.
